...
$id = $_SESSION['user'];
$Admin = new Admin($conn, "sponsorship");
...
if (isset($_POST['range-date-submit'])) {
    ...
    $sql = "SELECT sponsorship.*, admin.name FROM sponsorship
        INNER JOIN admin ON admin.id = sponsorship.approved_by
        WHERE sponsorship.date BETWEEN :start_date AND :end_date";
...
if ($range) {
    $sql = "SELECT SUM(amount) AS total_amount FROM sponsorship 
...
if (isset($_POST['submitSponsor'])) {
    ...
    if (!empty($name && $amount && $approved_by)) {
        ...
        if ($Admin->create($data)) {
            ...
            $alert = "showAlert('success', 'New Sponsorship Created Successfully')";
        } else {
            $alert = "showAlert('error', 'Couldn't Create Sponsorship')";
        }
    }
}
...
<body>
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <p>Are you sure want to delete this Sponsorship?</p>
    ...
    <div class="container">
                        ...
                        <form action="" method="POST">
                            <div class="card-body">
                                <div class="form-group mb-4">
                                    <label for="name">Sponsee Name*</label>
                                    <input type="text" class="form-control" id="name" name="name" placeholder="Enter the name of new supervisor" required>
                                </div>
        ...
        <button class="m-3 btn btn-success " data-bs-toggle="modal" data-bs-target="#exampleModal">New Sponsorship</button>
                    ...
                    <table id="dataTable1" class="table table-bordered table-striped display">
                        ...
                        <div>
                            ...
                            <tbody>
                                ...
                                <tr>
                                    <th><?php echo 'Overall Total Sponsorship'; ?></td>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <ul style="display: flex; justify-content: space-evenly" class="m-0">
                                            ...
                                            <a href="#" class="btn btn-danger" data-toggle="modal" data-target="#confirm-delete" data-href="./delete.php?table=sponsorship&id=<?php echo $result['id']; ?>">
                                                Delete
                                            </a>
                                        </ul>
                                    </td>
